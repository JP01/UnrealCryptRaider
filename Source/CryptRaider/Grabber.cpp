...
void UGrabber::Release()
{
	...
	if (GrabbedComponent)
	{
		...
		// Wake the physics in the edge case that player hasn't moved for a
		// while sending physics to sleep
...
UPhysicsHandleComponent* UGrabber::GetPhysicsHandle() const
{
	...
	{
		UE_LOG(
			LogTemp, Error, TEXT("Grabber Requires a UPhysicsHandleComponent"));
	}
